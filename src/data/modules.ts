...
export const TRAINING_MODULES: TrainingModule[] = [
  ...
  },
  {
    ...
    description: "Understand the four criteria that every good set must meet to have a chance at closing.",
    videoUrl: "https://www.youtube.com/embed/zwTUVpnwrKo",
    content: `**Every good set consists of these four criteria:**\n\n**1. It was set with urgency. This is the most important of the 4.**\n• This means the homeowner understands they will need to make a decision at the end of the appointment in order to obtain the advertising home discount. The script will set these expectations properly.\n\n**2. All decision-makers must be present.**\n• This may be a single, unmarried person who lives alone, a husband and wife, or may include even more adults (co-signers or other home-owners).\n• If you are unsure if someone should be there as a decision-maker, err on the side of caution and ask.\n\n**3. They must give us a minimum of 45 minutes to an hour.**\n• If not, they will not have enough time to receive all of the information and understand the value.\n\n**4. The appointment has been set ASAP after initial contact.**\n• This point is less of a yes/no and more of a spectrum. More than half of all closes are same day sets.\n• While this is important, it is not as important as points 2 and 3. If faced with a decision of doing a same day that does not meet either points 2 or 3, or doing an appointment a day or two out that meets points 2 and 3, move forward with the latter.\n\n**In order to maintain urgency, we need to understand:**\n\n1. A homeowner would not likely make a decision at the end of an appointment without consulting other decision-makers.\n2. A homeowner would not likely make a decision on a large-ticket item like this without a minimum of 45 minutes worth of information.\n3. If the appointment is too far out, the urgency is lost. It contradicts our script. We do not set more than two days out EVER.\n\n**If any of the 4 criteria is not met, the appointment's chances of closing plummet toward zero.**\n\nCoordinators should be ready to walk away from a set rather than set an appointment that does not meet all 4 criteria.\n\n**1. First, you will try to work through any obvious issues they bring up.**\n**2. If the nature of the misalignment is that they don't want to meet the 4 criteria, you may use a takeaway:**\n• "Oh I see, well maybe it's not the right time then"\n• For takeaways to work, you must truly be willing to walk away.\n• Always phrase your takeaways casually, in order to:\n    — Drive home that we will secure an Advertising Home either way (no pressure proposition). Remember, we are the prize.\n    — Allow homeowners to qualify themselves. Sometimes a takeaway is necessary.`,
    order: 5,
    quiz: [
      {
        id: "fc1",
        question: "Which of the 4 criteria is the most important?",
        options: [
          "All decision-makers must be present",
          "It was set with urgency",
          "The appointment is set ASAP",
          "They must give a minimum of 45 minutes",
        ],
        correctAnswer: 1,
      },
      {
        id: "fc2",
        question: "What happens if any of the 4 criteria is not met?",
        options: [
          "The appointment still has a good chance",
          "The appointment's chances of closing plummet toward zero",
          "It only matters if two are missing",
          "Nothing — criteria are just guidelines",
        ],
        correctAnswer: 1,
      },
    ],

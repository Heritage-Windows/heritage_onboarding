...
export const TRAINING_MODULES: TrainingModule[] = [
  ...
  },
  {
    ...
    description: "Learn how to choose the right neighborhoods for maximum sales success.",
    videoUrl: "https://www.youtube.com/embed/_8oFEl00ccs",
    content: `Choosing the right neighborhood is one of the most important decisions you make each day. A great neighborhood can double or triple your results compared to a poorly chosen one.\n\nWatch the training video above to learn our proven neighborhood selection strategy, then complete the quiz below.`,
    order: 8,
    quiz: [
      {
        id: "ns1",
        question: "Why is neighborhood selection important for your success?",
        options: [
          "It doesn't matter — every neighborhood is the same",
          "The right neighborhood can dramatically increase your results",
          "You should only knock in new construction areas",
      ...
      {
        id: "ns2",
        question: "When should you evaluate and plan your neighborhood selection?",
        options: [
          "Only when your manager tells you to",
          "Never — just pick any street",
  ...
  },
  {
    ...
    title: "Negative Pre-qualifications",
    description: "Learn how to use negative pre-qualifications to filter prospects and increase close rates.",
    videoUrl: "https://www.youtube.com/embed/2Dk-1wLGoCA",
    content: `Negative pre-qualifications are a powerful technique that helps you identify serious buyers early in the conversation. Instead of convincing everyone, you strategically disqualify prospects who aren't a good fit — which paradoxically makes the remaining prospects more eager to buy.\n\nWatch the training video above to learn the technique, then complete the quiz below.`,
    order: 9,
    quiz: [
      {
        id: "np1",
        question: "What is the purpose of negative pre-qualifications?",
        options: [
          "To insult potential customers",
          "To filter out unqualified prospects and increase close rates",
          "To skip as many doors as possible",
          "To make the sales process longer",
        ],
        correctAnswer: 1,
      },
      {
        id: "np2",
        question: "How do negative pre-qualifications affect serious buyers?",
        options: [
          "They scare them away",
          "They have no effect",
          "They make prospects more eager to engage",
          "They confuse the prospect",
        ],
        correctAnswer: 2,
      },
    ],
  },
  {
    ...
    title: "Smokescreens and Objections",
    description: "Learn to handle common smokescreens and objections with confidence and empathy.",
    videoUrl: "https://www.youtube.com/embed/4-E22GkbbI4",
    content: `Every successful salesperson encounters smokescreens and objections. The key is to recognize what the homeowner is really saying and respond in a way that keeps the conversation moving.\n\nWatch the training video above, then work through the sub-sections below for common objection scenarios you will face in the field.\n\nRemember the LAER Framework for every objection:\n• **Listen** — Let them finish speaking\n• **Acknowledge** — Validate their concern\n• **Explore** — Ask questions to understand the real issue\n• **Respond** — Address with relevant information\n\nComplete each sub-section's quiz to finish this module.`,
    order: 10,
    quiz: [],
    subModules: [
      {
        ...
        quiz: [
          ...
          {
            id: "ca2",
            question: "Why is 'I can't afford it' often a positive sign?",
            options: [
              "It means they want a discount",
              "It shows they're thinking about the purchase",
              "It means they'll buy next month",
      ...
      },
      {
        ...
        quiz: [
          ...
          {
            id: "wf2",
            question: "What is a good no-pressure next step to offer?",
            options: [
              "A binding contract",
              "A free window inspection",
              "A phone call with your manager",
              "A brochure and nothing else",
            ],
            correctAnswer: 1,
          },
        ],
      },
      {
        ...
        quiz: [
          ...
          {
            id: "hm2",
            question: "What should you pivot the conversation toward?",
            options: [
              "A different product",
              "A free in-home consultation for a personalized quote",
      ...
      },
      {
        ...
        quiz: [
          ...
          },
          {
            ...
            options: [
              "Nothing — just leave",
              "Set a specific callback time and leave materials",
              "Tell them the offer expires today",
              "Ask for their spouse's phone number",
            ],
            correctAnswer: 1,
          },
        ],
      },
      {
        ...
        videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
        content: `This is the most common objection and often the most reflexive — many people say it before they even know what you're offering.\n\nWhy They Say It:\n• It's a knee-jerk reaction to any salesperson\n• They may have had bad experiences with other companies\n• They could be busy or having a bad day\n\nHow to Respond:\n"I completely understand — most of our happiest customers said the same thing at first! I'm not here to pressure you. Would it be okay if I just left you some information about how homeowners in [neighborhood] are saving on energy costs? No obligation at all."\n\nKey Points:\n• Be gracious — a smile goes a long way\n• Don't take it personally; it's usually not about you\n• Leave a card or flyer — they may reach out later\n• Move on quickly; your time is valuable too\n• Some of your best future customers will come from callbacks`,
        quiz: [
          {
            id: "ni1",
          ...
          {
            id: "ni2",
            question: "What should you always do after a 'not interested' response?",
            options: [
              "Argue your case more firmly",
              "Be gracious, leave a card, and move on",
              "Ask why they're not interested repeatedly",
              "Knock again in 10 minutes",
            ],
            correctAnswer: 1,
          },
        ],
      },
      {
        ...
        videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
        content: `If they truly just got new windows, this conversation is done — but use it as a referral opportunity.\n\nWhy They Say It:\n• They genuinely replaced their windows recently\n• They might be exaggerating — "recently" could mean 5-10 years ago\n• They may have only replaced some windows\n\nHow to Respond:\n"That's great! How are you liking them? Are they performing the way you expected? If you ever need anything in the future, here's my card. Also — do you happen to know any neighbors who might be looking at their windows? We have a great referral program."\n\nKey Points:\n• Be genuinely happy for them — no awkwardness\n• Ask how the windows are performing — they might reveal issues\n• Pivot to referrals — they might know someone\n• Leave your card; their "new" windows might not be that new\n• If they only did some windows, there may still be an opportunity`,
        quiz: [
          {
            id: "nw1",
          ...
          {
            id: "nw2",
            question: "Why should you ask how their new windows are performing?",
            options: [
              "To make small talk",
              "They might reveal issues or have only replaced some windows",
              "To prove Heritage is better",
      ...
      },
      {
        ...
        videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ",
        content: `Homeowners planning to move often don't realize that new windows can increase their home's value and help it sell faster.\n\nWhy They Say It:\n• They don't want to invest in a home they're leaving\n• They think new windows only benefit the next owner\n• They may be trying to politely end the conversation\n\nHow to Respond:\n"That actually makes this perfect timing! New windows are one of the top home improvements for return on investment. Homes with new windows sell faster and for more money. It's one of the few upgrades that pays for itself at closing. Would it be worth a quick look to see how it could boost your home's value?"\n\nKey Points:\n• New windows offer 70-80% ROI at resale\n• Homes with new windows sell faster on average\n• Energy-efficient windows are a top buyer request\n• Frame it as an investment in their sale price, not an expense\n• Real estate agents often recommend window replacement before listing`,
        quiz: [
          {
            id: "pm1",
            question: "What ROI do new windows typically offer at resale?",
            options: [
              "20-30%",
              "40-50%",
              "70-80%",

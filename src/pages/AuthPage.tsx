        ...
        <div className="w-full max-w-sm space-y-8 animate-fade-in">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground">
              {isLogin
                ...
                : "New here? Set up your account to get started with training."}
            </p>
          </div>
          ...
          <p className="text-center text-sm text-muted-foreground">
            {isLogin ? (
              <>
                New here?{" "}
                <button type="button" onClick={() => setIsLogin(false)} className="text-primary font-semibold hover:underline">
                  Create an account
                </button>
              </>
            ) : (
              <>
                ...
                <button type="button" onClick={() => setIsLogin(true)} className="text-primary font-semibold hover:underline">
                  Sign in
                </button>
              </>
            )}
